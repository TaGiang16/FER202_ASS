...
import MovieBookingManager from "./Components/AdminPage/MovieBookingManager.js"; // Thêm import mới
import PriceDetail from "./Components/pages/PriceDetail.js"; // Thêm import mới
import UserTicketManager from "./Components/pages/UserTicketManager.js"; // Thêm import mới
import PriceHistoryManager from "./Components/AdminPage/PriceHistoryManager.js";
function App() {
  ...
  return (
    <Router>
      ...
      <Routes>
        ...
        <Route path="/price-detail" element={<PriceDetail />} /> {/* Route mới, công khai */}
        <Route
          path="/account"
          element={
        ...
        />
        <Route path="/movie-bookings" element={
          <ProtectedRoute element={<MovieBookingManager />} allowedRoles={"1"} />
        } /> {/* Route mới cho admin */}
        <Route path="/my-tickets" element={
          <ProtectedRoute element={<UserTicketManager />} allowedRoles={["1", "2"]} />
        } /> {/* Route mới cho user */}
        <Route
          path="/price-history"
          element={<ProtectedRoute element={<PriceHistoryManager />} allowedRoles={"1"} />}
        />
      </Routes>
